...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col">
      <SEO 
        title="Consigning Women | Best Consignment Shop Atlanta & Dunwoody"
        description="Consigning Women is Atlanta's first choice for upscale resale. Visit our Dunwoody boutique for designer labels like Chanel and Gucci. High-quality apparel at fabulous prices."
        keywords="consigning women dunwoody, consignment shops dunwoody ga, designer resale atlanta, upscale consignment atlanta, luxury resale atlanta, mt vernon rd consignment"
      />
      {/* Hero Section */}
      <section className="relative h-[85vh] min-h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Upscale Fashion Consignment Dunwoody" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-xl animate-in fade-in slide-in-from-left-8 duration-1000">
            <h1 className="text-5xl md:text-7xl font-serif font-bold text-gray-900 leading-tight mb-6">
              Atlanta's First Choice for <span className="text-fuchsia-brand italic">Consignment.</span>
            </h1>
            <p className="text-xl text-gray-700 mb-10 leading-relaxed font-medium">
              We offer great values on high quality new and gently used apparel and accessories in the current styles you love… all at fabulous prices.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center p-8 rounded-3xl bg-gray-50/50 border border-gray-50 hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-500">
              ...
              <h3 className="text-2xl font-serif font-bold text-gray-900 mb-4">Dunwoody Boutique</h3>
              <p className="text-gray-600 leading-relaxed">Visit our location in Dunwoody at 2508 Mount Vernon Road. A destination experience for savvy shoppers.</p>
            </div>
          </div>
        </div>
      </section>
